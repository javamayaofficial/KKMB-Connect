    ...
    <header class="sticky top-0 z-30 bg-white/80 dark:bg-slate-900/80 backdrop-blur border-b border-slate-200 dark:border-slate-800">
        <div class="max-w-lg mx-auto px-4 h-14 flex items-center justify-between">
            ...
            <div class="flex items-center gap-1">
                <a href="{{ route('notifications.index') }}" class="relative p-2 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800">
                ...
                <button @click="dark = !dark; localStorage.theme = dark ? 'dark' : 'light'" class="p-2 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800">
                ...
                <form method="POST" action="{{ route('logout') }}">@csrf
                    <button class="p-2 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-400">
